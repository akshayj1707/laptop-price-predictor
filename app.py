...
if st.button('Predict Price'):
    ...
    prediction = int(np.exp(file.predict(query)[0]))

    st.title(f"Predicted price for {company} series laptop could be between {str(prediction-1000)}₹ to {str(prediction+1000)}₹")
